...
public class ConfluentCloudConsumer {

    private final static Logger logger = LoggerFactory.getLogger(ConfluentCloudConsumer.class);
    ...
    private final static String JAAS_CONFIG = "org.apache.kafka.common.security.plain.PlainLoginModule   required username=\"H5YWAK2WUCZSOKLQ\"   password=\"HjdrHRNbqzPTMAYunKFuJ2Kr3oHyXeGTv8+fpzZBHY6RzafaRSMPXaDvNqbReIet\";";
